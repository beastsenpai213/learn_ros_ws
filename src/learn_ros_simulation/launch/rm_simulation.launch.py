...
def get_world_config(world_type):
    world_configs = {
        WorldType.CUBE: {
            ...
            'z': '0.0',
            'yaw': '0.0',
            'world_path': 'BIGCUBE2/BIGCUBE2.world'
        }
    }
...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('learn_ros_simulation')
    pkg_gazebo_ros = get_package_share_directory('gazebo_ros')

    # Specify xacro path
    urdf_dir = get_package_share_path('learn_ros_simulation') / 'urdf' / 'simulation_waking_robot.xacro'
        ...
        return GroupAction(
            ...
            actions=[
                ...
                IncludeLaunchDescription(
                    ...
                    launch_arguments={'world': os.path.join(bringup_dir, 'world', world_config['world_path']),'gui': 'false'}.items(),
                )
            ]
        )


    bringup_CUBE_cmd_group = create_gazebo_launch_group(WorldType.CUBE)
    ...
    ld.add_action(bringup_CUBE_cmd_group)
